    ...
    with conn:
        ...
        while True:
            ...
            if packet.packet_type == Packet.KOBUKI:
                ...
                text_turtle.goto(-300, -400)
                text_turtle.goto(300, -400)
                text_turtle.goto(300, -300)
                text_turtle.goto(-300, -300)
                text_turtle.end_fill()
                text_turtle.goto(-270, -330)
                text_turtle.color(machine_color[packet.packet_data.machine.robot])
                text_turtle.write("Robot: " + machine_text[packet.packet_data.machine.robot], False, "left", font=("Arial", 16, "normal"))
                text_turtle.goto(-270, -350)
                text_turtle.color(machine_color[packet.packet_data.machine.repair])
                text_turtle.write("Repair: " + machine_text[packet.packet_data.machine.repair], False, "left", font=("Arial", 16, "normal"))
                text_turtle.goto(-270, -370)
                text_turtle.color(machine_color[packet.packet_data.machine.motion_planner])
                text_turtle.write("Motion Planner: " + machine_text[packet.packet_data.machine.motion_planner], False, "left", font=("Arial", 16, "normal"))
                text_turtle.goto(-270, -390)
                text_turtle.color(machine_color[packet.packet_data.machine.motion_primitives])
                text_turtle.write("Motion Primitives: " + machine_text[packet.packet_data.machine.motion_primitives], False, "left", font=("Arial", 16, "normal"))
