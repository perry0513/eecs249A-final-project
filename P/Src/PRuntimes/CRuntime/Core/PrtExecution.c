...
#define lh_value_receive_result_ptr(r)      ((lh_value)((intptr_t)r))

#define lh_event_id_list_ptr_value(v)      ((event_id_list_ptr)lh_ptr_value(v))
#define lh_value_event_id_list_ptr(r)      ((lh_value)((intptr_t)r))
...
lh_value receive_handler_action(lh_value rargsv)
{
	...
	return ((lh_value)((intptr_t)(rargs->fun(rargs->context, rargs->args))));
}
